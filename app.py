...
<body>
    ...
    <div class="content-section">
        ...
        <p>生演奏やリアルタイム入力されたMIDIデータや、DAW搭載の大げさなヒューマナイズは、時として音量のバラつき（ダイナミクス）が大きすぎ、ミックスの中で音が埋もれたり、逆に突き出しすぎたりすることがあります。本ツールは全体の平均値を算出し、音楽的なニュアンスを残しながら音量を一定の範囲に収めることで、コンプレッサーのような安定感をもたらします。</p>
